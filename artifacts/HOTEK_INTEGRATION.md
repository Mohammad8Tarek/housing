...
1. **Interface Type**: `Fidelio`
   *(Do NOT select TCP/IP or File interfaces, as they use proprietary formats instead of standard FIAS)*
...
2. **Card 2**: Backend sends `KTD` (Key Type Duplicate). This ensures Card 2 works *alongside* Card 1.
