  ...
  const targetProfile = await withTenant(targetPropertyId, async (targetDb) => {
    ...
    if (existing) {
      ...
      const [updated] = await targetDb
        ...
        .set({
          ...
          firstNameAr: sourceProfile.firstNameAr || existing.firstNameAr,
          lastNameAr: sourceProfile.lastNameAr || existing.lastNameAr,
          thirdNameAr: sourceProfile.thirdNameAr || existing.thirdNameAr,
          fourthNameAr: sourceProfile.fourthNameAr || existing.fourthNameAr,
          jobTitle: sourceProfile.jobTitle || existing.jobTitle,
          jobTitleAr: sourceProfile.jobTitleAr || existing.jobTitleAr,
          department: sourceProfile.department || existing.department,
          departmentAr: sourceProfile.departmentAr || existing.departmentAr,
    ...
    const [inserted] = await targetDb
      ...
      .values({
        ...
        firstNameAr: sourceProfile.firstNameAr || "",
        lastNameAr: sourceProfile.lastNameAr || "",
        thirdNameAr: sourceProfile.thirdNameAr || "",
        fourthNameAr: sourceProfile.fourthNameAr || "",
