...
const MIGRATIONS = [
  ...
  {
    name: "user_signatures.on_delete_cascade",
    q: `DO $$ BEGIN
  ...
  {
    name: "hosting_request_approval_steps.signed_by_user_id_set_null",
    q: `DO $$ BEGIN
  ...
  {
    name: "hosting_requests.requester_user_id_set_null",
    q: `DO $$ BEGIN
  ...
  {
    name: "public.hr_sync_config.esign_config",
...
We wish you a safe trip and a pleasant stay! ✨';`,
  ...
  {
    name: "public.user_password_reset_otps",
    q: `CREATE TABLE IF NOT EXISTS public.user_password_reset_otps (
      id SERIAL PRIMARY KEY,
