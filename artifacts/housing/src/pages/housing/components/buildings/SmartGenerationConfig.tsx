            ...
            <div className="flex items-center justify-between px-4 py-2.5 bg-muted/40">
              ...
              >
                ...
                <span className="text-xs text-muted-foreground ml-1">
                  — {fc.roomsCount} {ar ? "غرفة" : "rooms"} · {fc.roomType} ·{" "}
                  {fc.roomCapacity} {ar ? "سرير" : "beds/room"}
                </span>
              ...
              <div className="p-4 grid grid-cols-2 gap-3 bg-muted/10">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFloorConfig(idx, { floorNumber: e.target.value })
                    }
                    placeholder="1"
                  />
                </div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFloorConfig(idx, {
                        roomsCount: Math.max(1, Number(e.target.value)),
                      })
                    }
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  <Label className="text-xs">
                    {ar ? "سعة الغرفة (أسرة)" : "Room Capacity (beds)"}
                  </Label>
                  <Input
                    type="number"
                    min={1}
                    ...
                    onChange={(e) =>
                      updateFloorConfig(idx, {
                        roomCapacity: Math.max(1, Number(e.target.value)),
                      })
                    }
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateFloorConfig(idx, {
                        roomStartNumber: Math.max(1, Number(e.target.value)),
                      })
                    }
                  />
                </div>
