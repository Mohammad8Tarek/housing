    ...
    <div className="overflow-hidden rounded-lg border bg-card shadow-sm">
      <div className="flex flex-col gap-2 border-b px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        >
          ...
          {selectedRowsSize > 0 && (
            <span
              className={ar ? "mr-1.5 text-primary" : "ml-1.5 text-primary"}
            >
      ...
      <div className="grid gap-3 p-4 [grid-template-columns:repeat(auto-fit,minmax(180px,1fr))]">
          ...
          <div className={filterFieldClass}>
            ...
            {propId && (
              <p className="text-[10px] text-muted-foreground truncate block">
                {ar ? "الحالي: " : "Now: "}
                {properties.find((p: any) => p.id === propId)?.name ??
                  `#${propId}`}
              </p>
            )}
          </div>
        ...
        {["housing", "assignments", "maintenance", "hostings"].includes(
          activeTab,
        ) && (
          <div className={filterFieldClass}>
            <label className={filterLabelClass}>
        ...
        {["housing", "assignments", "maintenance", "hostings"].includes(
          ...
          <div className={filterFieldClass}>
            ...
            <Select
              ...
              disabled={filterBuilding === "all" && floorOptions.length === 0}
            >
              <SelectTrigger className={filterControlClass}>
        ...
        {["employees", "assignments", "reservations", "hostings"].includes(
          activeTab,
        ) &&
        ...
        {["employees", "housing", "assignments", "hostings"].includes(
          activeTab,
        ) && (
          <div className={filterFieldClass}>
            <label className={filterLabelClass}>
