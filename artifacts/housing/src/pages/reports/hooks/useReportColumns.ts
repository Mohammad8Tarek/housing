...
export const REPORT_TAB_COLUMNS: Record<string, ColDef[]> = {
  ...
  policy_exceptions: [
    ...
    { key: "approvalStatus", label: "Approval Status", labelAr: "حالة الاعتماد" },
  ...
  vacations: [
    ...
    { key: "roomType", label: "Room Type", labelAr: "نوع الغرفة" },
    { key: "genderLabel", label: "Gender", labelAr: "الجنس" },
    { key: "nationalityLabel", label: "Nationality", labelAr: "الجنسية" },
