...
exports.modules = {
  /***/ 77376: /***/ (
    ...
    var external_node_fs_ = __webpack_require__(73024); // CONCATENATED MODULE: ./node_modules/is-docker/index.js
    let isDockerCached;
    ...
    /* harmony default export */ const is_wsl = external_node_process_.env
      .__IS_WSL_TEST__
      ? isWsl
      : isWsl(); // CONCATENATED MODULE: ./node_modules/wsl-utils/index.js
    ...
    const wslDrivesMountPoint = (() => {
      ...
      return async function () {
        ...
        const configContent = await promises_.readFile(configFilePath, {
          encoding: "utf8",
        });
    ...
    const execFileAsync = (0, external_node_util_.promisify)(
      external_node_child_process_.execFile,
    );
    ...
    const run_applescript_execFileAsync = (0, external_node_util_.promisify)(
      external_node_child_process_.execFile,
    );
    ...
    async function runAppleScript(
      ...
      const { stdout } = await run_applescript_execFileAsync(
        "osascript",
    ...
    const windows_execFileAsync = (0, external_node_util_.promisify)(
      external_node_child_process_.execFile,
    );
    ...
    const _windowsBrowserProgIdMap = new Map(
    ...
    const default_browser_execFileAsync = (0, external_node_util_.promisify)(
      external_node_child_process_.execFile,
    );
    ...
    const execFile = (0, external_node_util_.promisify)(
      external_node_child_process_.execFile,
    );

    // Path to included `xdg-open`.
    const open_dirname = external_node_path_.dirname(
      (0, external_node_url_.fileURLToPath)(
...
*/
    async function getWindowsDefaultBrowserFromWsl() {
      ...
      const encodedCommand = external_node_buffer_.Buffer.from(
        rawCommand,
        "utf16le",
      ).toString("base64");
    ...
    const baseOpen = async (options) => {
      ...
      if (app === "browser" || app === "browserPrivate") {
        ...
        const browser = is_wsl
          ? await getWindowsDefaultBrowserFromWsl()
          : await default_browser_defaultBrowser();
        ...
        throw new Error(
          `${browser.name} is not supported as a default browser`,
        );
      }
      ...
      if (platform === "darwin") {
        ...
        options.target = external_node_buffer_.Buffer.from(
        ...
        if (app) {
          ...
          const useSystemXdgOpen =
            external_node_process_.versions.electron ??
      ...
      const subprocess = external_node_child_process_.spawn(
        command,
        cliArguments,
        childProcessOptions,
      );
