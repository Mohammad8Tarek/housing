...
async function run() {
  ...
  const res2 = await remote.query(
    "SELECT column_name, data_type, table_schema FROM information_schema.columns WHERE table_name = 'employee_portal_accounts' ORDER BY table_schema, ordinal_position",
  );
