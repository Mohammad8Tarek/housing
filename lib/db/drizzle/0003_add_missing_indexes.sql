...
-- ============================================================
-- Uses where possible to avoid locking tables.
...
-- ─── hostings ─────────────────────────────────────────────────────────────
CREATE INDEX IF NOT EXISTS idx_hostings_employee_id
  ON hostings(employee_id);

CREATE INDEX IF NOT EXISTS idx_hostings_room_id
  ON hostings(room_id);

CREATE INDEX IF NOT EXISTS idx_hostings_status
  ON hostings(status);

CREATE INDEX IF NOT EXISTS idx_hostings_expected_from
  ON hostings(expected_from);

-- ─── reservations ─────────────────────────────────────────────────────────
CREATE INDEX IF NOT EXISTS idx_reservations_employee_id
...
-- ─── maintenance ──────────────────────────────────────────────────────────
CREATE INDEX IF NOT EXISTS idx_maintenance_room_id
...
-- ─── room_keys ────────────────────────────────────────────────────────────
CREATE INDEX IF NOT EXISTS idx_room_keys_room_id
  ON room_keys(room_id);

CREATE INDEX IF NOT EXISTS idx_room_keys_status
  ON room_keys(status);

CREATE INDEX IF NOT EXISTS idx_room_keys_assignment_id
  ON room_keys(assignment_id);

-- ─── employee_portal_accounts ─────────────────────────────────────────────
-- Hot table — every portal login queries this
CREATE INDEX IF NOT EXISTS idx_portal_accounts_employee_id
  ON employee_portal_accounts(employee_id);

-- ─── hosting_companions ───────────────────────────────────────────────────
CREATE INDEX IF NOT EXISTS idx_hosting_companions_hosting_id
