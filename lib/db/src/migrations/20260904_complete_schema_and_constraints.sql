...
We wish you a safe trip and a pleasant stay! ✨',
  ...
  -- --------------------------------------------------------
  -- Table: public.property_housing_ratings (Automated 7-Day Pulse)
  -- --------------------------------------------------------
  CREATE TABLE IF NOT EXISTS public.property_housing_ratings (
    id SERIAL PRIMARY KEY,
  ...
  -- --------------------------------------------------------
  -- Table: public.property_housing_pulse_config (Housing Pulse Survey Configuration & Trigger)
  -- --------------------------------------------------------
  CREATE TABLE IF NOT EXISTS public.property_housing_pulse_config (
    id SERIAL PRIMARY KEY,
    property_id INTEGER NOT NULL UNIQUE REFERENCES public.properties(id) ON DELETE CASCADE,
  ...
  -- --------------------------------------------------------
  -- Table: public.room_moves (Room & Bed Moves Log / PMS Report)
  -- --------------------------------------------------------
