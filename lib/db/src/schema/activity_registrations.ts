...
export const insertActivityRegistrationSchema = createInsertSchema(activityRegistrationsTable).omit({ id: true, createdAt: true, attendedAt: true });
export type InsertActivityRegistration = z.infer<typeof insertActivityRegistrationSchema>;
export type ActivityRegistration = typeof activityRegistrationsTable.$inferSelect;
