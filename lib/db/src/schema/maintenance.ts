...
export const maintenanceTable = pgTable("maintenance", {
  ...
  parentId: integer("parent_id").references((): any => maintenanceTable.id, { onDelete: "cascade" }),
...
export const insertMaintenanceSchema = createInsertSchema(maintenanceTable).omit({ id: true, createdAt: true, reportedAt: true, assignedTo: true });
