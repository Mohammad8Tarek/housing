...
export const portalConversationParticipantsTable = pgTable("portal_conversation_participants", {
  id:             serial("id").primaryKey(),
...
export const insertConversationSchema = createInsertSchema(portalConversationsTable).omit({ id: true, createdAt: true, updatedAt: true });
export const insertMessageSchema = createInsertSchema(portalMessagesTable).omit({ id: true, createdAt: true, editedAt: true, deletedAt: true }).extend({
...
export type ConversationParticipant = typeof portalConversationParticipantsTable.$inferSelect;
