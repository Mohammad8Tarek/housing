...
export const insertPortalFeedbackSchema = createInsertSchema(portalFeedbackTable).omit({ id: true, createdAt: true, updatedAt: true });
export const insertPortalCommentSchema  = createInsertSchema(portalCommentsTable).omit({ id: true, createdAt: true, likesCount: true });
