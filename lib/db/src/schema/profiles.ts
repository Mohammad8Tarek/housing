...
export const profilesTable = pgTable("profiles", {
  ...
  firstNameAr: text("first_name_ar").default(""),
  lastNameAr: text("last_name_ar").default(""),
  thirdNameAr: text("third_name_ar").default(""),
  fourthNameAr: text("fourth_name_ar").default(""),
  nationalId: text("national_id").notNull(),
  nationality: text("nationality").notNull().default(""),
  address: text("address").notNull().default(""),
  jobTitle: text("job_title").notNull().default(""),
  jobTitleAr: text("job_title_ar").default(""),
  level: text("level").notNull().default(""),
  phone: text("phone").notNull().default(""),
  department: text("department").notNull().default(""),
  departmentAr: text("department_ar").default(""),
