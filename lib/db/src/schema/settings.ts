...
export const settingsTable = pgTable("settings", {
  ...
  departureAlertsEnabled: boolean("departure_alerts_enabled").notNull().default(true),
  departureAlertThreshold: integer("departure_alert_threshold").notNull().default(3),
  reportFooter: text("report_footer").notNull().default("Generated by Sunrise Housing System"),
