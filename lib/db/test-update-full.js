...
async function run() {
  ...
  try {
    ...
    await pool.query(
      `INSERT INTO public.employee_portal_accounts (property_id, employee_id, password_hash, must_change_password) VALUES (1, 'EMP002', 'dummy', false)`,
    );
    ...
    const existing = await db
      ...
      .where(eq(employeePortalAccountsTable.employeeId, "EMP002"))
      .limit(1);
